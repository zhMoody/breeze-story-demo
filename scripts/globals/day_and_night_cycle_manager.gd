...
func recalculate_time():
	...
	var current_day_minute: int = total_minute % MINUTES_PER_DAY
	var hour: int = int(current_day_minute / MINUTES_PER_HOUR)
	var minute: int = int(current_day_minute % MINUTES_PER_HOUR)
